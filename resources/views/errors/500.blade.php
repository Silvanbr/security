...
<div>
    ...
    <h2 class =" is-size-4 has-text-weight-bold has-text-centered">Server Error</h2>
    <p class ="has-text-centered"> De server is is tegen een fout aan gelopen en kan uw request niet uitvoeren, dit is niet uw fout.</p>
    <p class ="has-text-centered"> Wacht alstublieft een paar minuten en probeer dan opnieuw, ook kunt u misschien uw internetverbinding testen.</p>
    <p class ="has-text-centered"> Als u tegen deze error aan blijft lopen laat het ons dan alstublieft weten. </p>
    <div class="box has-text-centered">
        ...
        <a role="button" class="button has-background-primary has-text-white" onclick='window.location.reload();'>refresh pagina</a>
    </div>
